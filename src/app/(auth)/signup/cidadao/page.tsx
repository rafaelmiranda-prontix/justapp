...
import { ArrowLeft, Scale, UserCircle, CheckCircle2 } from 'lucide-react'

export default function SignupCidadaoPage() {
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Hero Section */}
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-lg">
            ...
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Resolva seu problema jurídico com o advogado certo
            </h1>

            <p className="text-xl text-white/90 mb-8">
              Crie sua conta grátis e encontre especialistas qualificados em minutos.
            </p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-2">
            <CardHeader className="space-y-1 pb-6">
              <CardTitle className="text-2xl font-bold">Cadastro de Cidadão</CardTitle>
              <CardDescription className="text-base">
                Crie sua conta gratuita para encontrar advogados especializados
              </CardDescription>
            </CardHeader>
            <CardContent>
              <SignupCidadaoForm />
