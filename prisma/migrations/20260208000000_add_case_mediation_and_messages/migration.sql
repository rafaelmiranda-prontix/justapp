-- AlterTable: add mediation and close fields to casos
...
-- Add closeReason to casos (after enum exists)
ALTER TABLE "casos" ADD COLUMN IF NOT EXISTS "closeReason" "CloseReason";

-- Add EM_MEDIACAO to CasoStatus enum (safe if already exists)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- CreateEnum: CaseMessageSenderRole
DO $$ BEGIN
...
-- CreateEnum: CaseMessageVisibility
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS "case_messages_casos_mediatedByAdminId_idx" ON "casos"("mediatedByAdminId");
